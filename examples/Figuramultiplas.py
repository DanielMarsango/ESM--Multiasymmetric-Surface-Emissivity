...
arm = spiral_arm(-xi, xf, n, 210, 500, 55, 90)
...
axs[0].imshow(disk_final, extent=[-2500, 2500, -2500, 2500], vmin=0.1, vmax=1, cmap='hot')
axs[0].set_xlabel('rg')
axs[0].set_ylabel('rg')
axs[0].set_facecolor('white')
axs[0].set_title('(a)')
axs[0].text(890,1120, r'$\epsilon_{A1}(\phi)$',fontsize=12)
axs[0].text(-100,-1520, r'$\epsilon_{A2}(\phi)$',fontsize=12)
...
disk_final[disk_final == 0] = 50
# Plot da imagem à direita
axs[1].imshow(disk_final, extent=[-2500, 2500, -2500, 2500], vmin=0.1, vmax=1, cmap='hot')
axs[1].set_xlabel('rg')
axs[1].set_ylabel('rg')
axs[1].set_facecolor('white')
axs[1].set_title('(b)')
axs[1].text(1200,800, r'$\epsilon_A(\phi)$',fontsize=12)
#axs[1].text(700,-1280, r'$\epsilon_{G2}(x,y)$',fontsize=12)
axs[1].text(-1500,-1310, r'$\epsilon_{G}(x,y)$',fontsize=12)
axs[1].text(-1300,1810, r'$\epsilon_E(x,y)$',color="white",fontsize=12)
plt.tight_layout()
plt.savefig("discomultiplas.jpg",dpi=300)
plt.show()
#plt.close()
...
# Matriz de cálculo final
disk_final = disk*(rad*(arm+g1+arcelp))
...
axs[0].set_facecolor('white')
axs[0].set_title('(a)')
axs[0].text(1300,-760, r'$\epsilon_A(\phi)$',fontsize=12)
#axs[0].text(700,-1280, r'$\epsilon_{G2}(x,y)$',fontsize=12)
axs[0].text(-1500,-1310, r'$\epsilon_{G}(x,y)$',fontsize=12)
axs[0].text(-1300,1810, r'$\epsilon_E(x,y)$',color="white",fontsize=12)

#rad = radial_profile(-xi, xf, n, -1.5, 0.8, 1500)
...
axs[1].set_facecolor('white')
axs[1].set_title('(b)')
axs[1].text(1300,-760, r'$\epsilon_A(\phi)$',fontsize=12)
#axs[1].text(700,-1280, r'$\epsilon_{G2}(x,y)$',fontsize=12)
axs[1].text(-1500,-1310, r'$\epsilon_{G}(x,y)$',fontsize=12)
axs[1].text(-1300,1810, r'$\epsilon_E(x,y)$',color="white",fontsize=12)
plt.tight_layout()
plt.savefig("discomultiplas2.jpg",dpi=300)
plt.show()
#plt.close()
